...
async def _build_overview_kb(listing_id: int, defs: list[dict]) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text="⬅️ Назад к объявлению", callback_data=f"vac_view:{listing_id}:::my")])
